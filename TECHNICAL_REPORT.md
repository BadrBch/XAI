...
To address these deficiencies, we migrated to the **DenseNet121** architecture provided by the [`torchxrayvision`](https://github.com/mlmed/torchxrayvision) library.
